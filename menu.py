        ...
        while True:
            for event in pygame.event.get():
                if event.type == pygame.MOUSEBUTTONDOWN:
                    if pygame.mouse.get_pos()[0] >= 390 and pygame.mouse.get_pos()[1] >= 185.5:
                        if pygame.mouse.get_pos()[0] <= 890 and pygame.mouse.get_pos()[1] <= 265.5:
                            print("1")

                    if pygame.mouse.get_pos()[0] >= 390 and pygame.mouse.get_pos()[1] >= 285.5:
                        if pygame.mouse.get_pos()[0] <= 890 and pygame.mouse.get_pos()[1] <= 365.5:
                            print("2")

                    if pygame.mouse.get_pos()[0] >= 390 and pygame.mouse.get_pos()[1] >= 385.5:
                        if pygame.mouse.get_pos()[0] <= 890 and pygame.mouse.get_pos()[1] <= 465.5:
                            print("3")

                    if pygame.mouse.get_pos()[0] >= 390 and pygame.mouse.get_pos()[1] >= 485.5:
                        if pygame.mouse.get_pos()[0] <= 890 and pygame.mouse.get_pos()[1] <= 565.5:
                            print("4")

                    if pygame.mouse.get_pos()[0] >= 390 and pygame.mouse.get_pos()[1] >= 585.5:
                        if pygame.mouse.get_pos()[0] <= 890 and pygame.mouse.get_pos()[1] <= 665.5:
                            print("5")
