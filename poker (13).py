...
class Help():
    def __init__(self):
        self.helpPage1 = assets.menuFont.render("How to play", True, Colours.black)
        self.helpPage2 = assets.menuFont.render("How to win", True, Colours.black)
        self.helpPage3 = assets.menuFont.render("Possible hands", True, Colours.black)

        self.helpx = assets.inGameFont.render("", True, Colours.black)

        self.help1 = assets.inGameFont.render("To make a bet click the bet button, then use the arrows to increase or decrease your bet, when you want to make the bet click the box that your bet is in, if you do not wish to make a bet and the opponent has not made a bet click the check/call button and the next cards in the river will be displayed. At the start of each hand there are blinds which is a forced bet that both players have to bet, this is default to 100 chips however you can change this to be higher or lower in multiples of 50.", True, Colours.black)

        self.helpx = assets.inGameFont.render("To win get all of your opponents chips by betting your own chips with theirs when you think you have a better hand. E.g. if you only have one pair you may not want to bet as much as if you had a flush or straight.", True, Colours.black)
