...
##        self.screen.blit(cards.backOfCard,(605,0))
        ...
        pygame.draw.rect(self.screen, Colours.blue, (723, 600, 100, 50), 0) #Bet
        pygame.draw.rect(self.screen, Colours.blue, (723, 660, 100, 50), 0) #Call
        pygame.draw.rect(self.screen, Colours.blue, (833, 600, 100, 50), 0) #Fold
        ...
        self.screen.blit(self.upButton,(950,600))
        self.screen.blit(self.downButton,(950,660))
        ...
        pygame.draw.rect(self.screen, Colours.black, (445,600,105,80), 0)
        pygame.draw.rect(self.screen, Colours.black, (445,10,105,80), 0)
        pygame.draw.rect(self.screen, Colours.black, (1015, 635, 80, 40), 0)
        self.userBetText = self.font.render(str(self.bet), True, Colours.white)
        self.screen.blit(self.userBetText, (1020, 640))
        self.chipsText = self.font.render("Chips:", True, Colours.white)
        self.screen.blit(self.chipsText,(450,610))
        self.screen.blit(self.chipsText,(450,20))
        ...
        self.screen.blit(self.computerChipsText,(450,50))

        self.potBox = pygame.draw.rect(self.screen, Colours.black, (595,195,165,40))
                    ...
                    if event.type == pygame.MOUSEBUTTONDOWN:
                        if pygame.mouse.get_pos()[0] >= 950 and pygame.mouse.get_pos()[1] >= 600:
                            if pygame.mouse.get_pos()[0] <= 1000 and pygame.mouse.get_pos()[1] <= 650:
                                if user.Chips > 0:
                                    pygame.draw.rect(self.screen, Colours.black, (1015,635,80,40), 0)
                                    pygame.draw.rect(self.screen, Colours.black, (445,640,105,40), 0)
                                    ...
                                    self.screen.blit(self.upBetPress, (950,600))
                                    pygame.display.update()
                                    time.sleep(0.05)
                                    self.screen.blit(self.upButton,(950,600))
                                    pygame.display.update()
                        ...
                        if pygame.mouse.get_pos()[0] >= 950 and pygame.mouse.get_pos()[1] >= 660:
                            if pygame.mouse.get_pos()[0] <= 1000 and pygame.mouse.get_pos()[1] <= 7100:
                                if user.Chips < 5000:
                                    ...
                                    self.screen.blit(self.downBetPress, (950,660))
                                    pygame.display.update()
                                    time.sleep(0.1)
                                    self.screen.blit(self.downButton,(950,660))
                                    pygame.display.update()
                        ...
                        if pygame.mouse.get_pos()[0] >=1015 and pygame.mouse.get_pos()[1] >= 635:
                            if pygame.mouse.get_pos()[0] <= 1095 and pygame.mouse.get_pos()[1] <= 670:
                                if self.bet > 0:
                                    dealer.pot = self.bet
                                    self.bet = 0
                                    self.potBox = pygame.draw.rect(self.screen, Colours.black, (595,195,1651,40))
                                    self.potText = self.font.render("Pot: "+str(dealer.pot), True, (Colours.white))
                                    self.screen.blit(self.potText,(600,200))
                                    pygame.draw.rect(self.screen, Colours.black, (1015,635,80,40), 0)
                                    self.userBetText = self.font.render(str(self.bet), True, Colours.white)
