...
class Cards():
    ...
    def getCardList(self):
        ...
        for number in range(13):
            if number == 0:
                self.cardList.append(["C"+str(number+1)+".JPG", "C", 13])
            else:
                self.cardList.append(["C"+str(number+1)+".JPG", "C", number])
        for number in range(13):
            if number == 0:
                self.cardList.append(["D"+str(number+1)+".JPG", "D", 13])
            else:
                self.cardList.append(["D"+str(number+1)+".JPG", "D", number])
        for number in range(13):
            if number == 0:
                self.cardList.append(["H"+str(number+1)+".JPG", "H", 13])
            else:
                self.cardList.append(["H"+str(number+1)+".JPG", "H" ,number])
        for number in range(13):
            if number == 0:
                self.cardList.append(["S"+str(number+1)+".JPG", "S", 13])
            else:
                self.cardList.append(["S"+str(number+1)+".JPG", "S", number])
...
class Game():
    ...
    def displayFlop(self):
        while self.flopX > 600:
            for i in range(3):
                self.flopCards = pygame.image.load(river.riverCards[i][0])
    ...
    def displayTurn(self):
        self.flopCards = pygame.image.load(river.riverCards[3][0])
        self.flopCards = pygame.transform.scale(self.flopCards, self.cardScale)
    ...
    def displayRiver(self):
        self.flopCards = pygame.image.load(river.riverCards[4][0])
        self.flopCards = pygame.transform.scale(self.flopCards, self.cardScale)
    ...
    def getHandValue(self):
        ...
        self.userHand = [["y", "H", 8], ["t", "H", 2], ["r", "D", 8], ["t0", "H", 5], ["t", "D", 6], ["df", "H", 7], ["ar", "S", 2]]
        for x in range(7):
