...
import random, pygame, sys, time, menu1
...
class Assets():
    def __init__(self):
        ...
        self.userBetText = self.inGameFont.render("0", True, Colours.white)
        self.userChipsText = self.inGameFont.render("5000", True, Colours.white)
        self.computerChipsText = self.inGameFont.render("5000", True, Colours.white)
        self.chipsText = self.inGameFont.render("Chips:", True, Colours.white)
        self.potText = self.inGameFont.render("Pot: 0", True, (Colours.white))
...
class Game():
    def __init__(self):
        ...
        pygame.draw.rect(screen, Colours.black, (445,600,105,80), 0) # User chips background
        pygame.draw.rect(screen, Colours.black, (445,10,105,80), 0) # Computer chips background
        pygame.draw.rect(screen, Colours.black, (1015, 635, 80, 40), 0) # User bet background
        ...
        self.potBox = pygame.draw.rect(screen, Colours.black, (595,195,165,40)) # Pot background
                        ...
                        if pygame.mouse.get_pos()[0] >= 950 and pygame.mouse.get_pos()[1] >= 600:
                            if pygame.mouse.get_pos()[0] <= 1000 and pygame.mouse.get_pos()[1] <= 650:
                                if user.Chips > 0:
                                    ...
                                    self.userBetText = assets.inGameFont.render(str(self.bet), True, Colours.white)
                                    screen.blit(self.userBetText,(1020,640))
                                    self.userChipsText = assets.inGameFont.render(str(user.Chips), True, Colours.white)
                        ...
                        if pygame.mouse.get_pos()[0] >=1015 and pygame.mouse.get_pos()[1] >= 635:
                            if pygame.mouse.get_pos()[0] <= 1095 and pygame.mouse.get_pos()[1] <= 670:
                                if self.bet > 0:
                                    ...
                                    self.potText = assets.inGameFont.render("Pot: "+str(dealer.pot), True, (Colours.white))
...
class Menu():
    def __init__(self):
        ...
        screen.blit(assets.titleText,(497.5,10))
